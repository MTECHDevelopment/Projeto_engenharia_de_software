<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        include_once('config.php');
            ...
            $result = mysqli_query($conexao, "INSERT INTO usuarios(materia, importancia, concluido, data_de_entrega, descricao) VALUES ($materia, $email, $telefone, $sexo, $data_nasc, $cidade, $estado, $endereco)");
    }
    ...
    <div class="box">
        <form action="">
            <fieldset>
                ...
                <input type="radio" id="concluido" name="concluido" value="concluido" required>
                ...
                <div class="inputBox">
                    ...
                    <label for="descricao" class="labelInput">Descrição do lembrete</label>
                </div>
                <br><br>
